...
public class RemovePlayer extends Command {
    ...
    public RemovePlayer(LitebansWebAPI api, AuthenticationHandler authenticationHandler, Map<String, Object> config) {
        super("remove");
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args.length != 2) {
            sender.sendMessage(LanguageManager.getBungeeMessageComponent(sender, "commands.players-whitelist.remove-player.usage"));
            return;
        }
