...
public class LoginHandler extends AbstractHandler {
    ...
    public LoginHandler(Logger logger, Map<String, Object> config, DatabaseUtils databaseUtils) {
        this.logger = logger;
        this.config = config;
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        if("/login".equalsIgnoreCase(target)) {
            ...
            if (oauthEnabled) {
                discordLoginButton = "            <div class=\"mt-6\">\n" +
            ...
            try {
                ...
                if (!databaseUtils.isUserRegistered(username)) {
