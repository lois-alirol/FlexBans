package fr.neocle.flexbans.velocity.command.helper.server;

import com.velocitypowered.api.proxy.Player;
import com.velocitypowered.api.proxy.ProxyServer;
import fr.neocle.flexbans.common.adapter.command.ICommandSource;
import fr.neocle.flexbans.common.command.server.unlock.IServerUnlockCommandHelper;
import fr.neocle.flexbans.velocity.command.adapter.command.VelocityCommandSource;

import java.util.List;
import java.util.stream.Collectors;

public class VelocityServerUnlockCommandHelper implements IServerUnlockCommandHelper {
    private final ProxyServer proxyServer;

    public VelocityServerUnlockCommandHelper(ProxyServer proxyServer) {
