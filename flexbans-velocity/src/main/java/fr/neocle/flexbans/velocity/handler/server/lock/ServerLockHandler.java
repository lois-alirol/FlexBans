package fr.neocle.flexbans.velocity.handler.server.lock;
...
public class ServerLockHandler implements ServerLockPlatformHandler {
    private final ProxyServer proxyServer;

    public ServerLockHandler(ProxyServer proxyServer) {
