...
public class PlayerHistoryHandler extends AbstractHandler {
    ...
    private static final int PAGE_SIZE = ConfigManager.getInt("webserver.pages.details.player.max-per-page");
    ...
    private String loadTemplate(HttpServletResponse response) throws IOException {
        ...
        if (htmlTemplate == null) {
            FlexLogger.warn("Unable to load HTML template for player history page.");
