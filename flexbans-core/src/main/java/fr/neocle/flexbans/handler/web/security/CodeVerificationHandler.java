...
import fr.neocle.flexbans.util.security.CodeGenerator;
...
public class CodeVerificationHandler extends AbstractHandler {
    ...
    public CodeVerificationHandler(DatabaseUtils databaseUtils) {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        if ("/code-verification".equalsIgnoreCase(target)) {
            ...
            if (htmlTemplate == null) {
                FlexLogger.warn("Unable to load HTML template for code verification.");
