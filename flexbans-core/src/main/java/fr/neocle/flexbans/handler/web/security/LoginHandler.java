package fr.neocle.flexbans.handler.web.security;
...
public class LoginHandler extends AbstractHandler {
    ...
    public LoginHandler(DatabaseUtils databaseUtils, EventDispatcher eventDispatcher) {
    ...
    private void recordFailedAttempt(String identifier) {
        ...
        if (attempt.attempts >= MAX_ATTEMPTS) {
            ...
            FlexLogger.warn("IP address locked out due to too many failed attempts: " + identifier);
        }
    }
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        if ("/login".equalsIgnoreCase(target)) {
            ...
            if (htmlTemplate == null) {
                FlexLogger.warn("Unable to load HTML template for login page.");
            ...
            try {
                ...
                FlexLogger.error("Error processing login: " + e.getMessage());
