...
public class KickExecutorImpl implements KickExecutor {
    private final fr.neocle.flexbans.api.platform.handler.KickPlatformHandler platformHandler;
    ...
    public KickExecutorImpl(fr.neocle.flexbans.api.platform.handler.KickPlatformHandler platformHandler,
